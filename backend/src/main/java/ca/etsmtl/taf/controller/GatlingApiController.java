...
public class GatlingApiController {
    ...
    @Autowired
    private GatlingConfigurator gatlingConfigurator;
    ...
    public ResponseEntity<Void> redirectToLatestReport() {
        String latestReportPath = gatlingConfigurator.getLatestReportPath();
        if (latestReportPath != null) {
            return ResponseEntity.status(HttpStatus.FOUND)
                    .location(URI.create("/reports/performance/gatling/dashboard/" + latestReportPath + "/index.html"))
                    .build();
        }
